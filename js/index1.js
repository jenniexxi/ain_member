(function () {
    ...
    var gnb = {
        elem: {
            ...
            mainMenuList : document.querySelectorAll(".menu-nav .main-menu-list"),
            ...
            moMenuWrap : document.querySelector(".menu-nav"),
        ...
        event: {
            ...
            moSubShow : function () {
                [].forEach.call(gnb.elem.subMenuList, function (__el, index) {
                    __el.addEventListener('click', function (__e) {
                        __e.preventDefault();
                        for (var i = 0; i < gnb.elem.subMenuList.length; i++) {
                            if (i !== index) {
                                gnb.elem.subMenuList[i].querySelector('span').classList.remove("on");
                            } else {
                                if (gnb.elem.subMenuList[i].querySelector('span').classList.contains("on") == true) {
                                    gnb.elem.subMenuList[i].querySelector('span').classList.remove("on");
                                } else {
                                    gnb.elem.subMenuList[i].querySelector('span').classList.add("on");
                                }
                            }
                        }
                    });
        ...
        accessibility: {
            KeyboardEvent: function () {
                [].forEach.call(gnb.elem.mainMenuList, function (__el, index) {
                    __el.addEventListener('keydown', function (__e) {
